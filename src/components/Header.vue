    ...
    <header class="border-gray-200 border shadow-md">
        <nav class="bg-white px-4 lg:px-6 py-2.5">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="hidden justify-between items-center lg:flex min-w-[450px]">
                    <form class="w-full">
                ...
                <div class="flex items-center">
                    <a href="#"
                        class="text-gray-800 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-non">Log
                        in</a>
                    <a href="#"
                        class="text-white bg-primary-700 hover:bg-primary-900 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none">Get
                        started</a>
                </div>
            </div>
        </nav>
